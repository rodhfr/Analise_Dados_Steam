...
def main():
    ...
    resultado_platforms = api_wrapper.fetch_platform_for_all_games(read_file_path='input.json', end_limit=15, write_file_path='furico_bom.json')

    resultado_time_beat = api_wrapper.fetch_time_beats_for_all_games(read_file_path='furico_bom.json', end_limit=15, write_file_path='furico_bolado.json')

    print(resultado_platforms)   
