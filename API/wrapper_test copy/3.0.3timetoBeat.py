    ...
    def fetch_time_beats_for_all_games(self, read_file_path, initial_limit = 0, end_limit = 0, write_file_path=''):
        ...
        for game_name in games_data.keys():
            ...
            if not time_to_beats_data:
                print(f"No data returned for game: {game_name}")
...
def main():
    ...
    resultado = api_wrapper.fetch_time_beats_for_all_games(read_file_path='input.json', end_limit=15, write_file_path='furicasso.json')
